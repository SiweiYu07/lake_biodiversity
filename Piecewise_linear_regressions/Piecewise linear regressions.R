...
plot(model, xlab = 'TP', ylab = 'Richness',pch=19,col="#33CCCC",cex=2,cex.axis=2,cex.lab=2,cex.sub=2,cex.main=2,lwd=4)
...
summary(lm_seg1)
plot(lm_seg1, xlab = 'TP', ylab = 'Richness',col="blue",lwd=8)
